  ...
  return (
    <ModalContainer display={modal.open ? "flex" : "none"}>
      ...
      <Modal>
        ...
        <Header>Sipariş Durumunu Güncelle</Header>
        <Form onSubmit={handleUpdate}>
          <Message>
            {order.status === "To Ship"
              ? "Siparişinizi iptal etmek istediğinizden emin misiniz? Kartınızdan ücret alınmayacaktır."
              : order.status === "Shipped"
              ? "Siparişinizi/siparişlerinizi düzgün bir şekilde aldınız mı? 'Evet'i seçerseniz, kartınızdan ücret alınacaktır."
              : null}
          </Message>
          <Agreement>
            <Label htmlFor="yes">
