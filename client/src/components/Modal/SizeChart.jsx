  ...
  return (
    <Container>
      <Wrapper>
        ...
        <Subheader>Nasıl ölçülür</Subheader>
        <Step>1</Step>
        <Description>
            Ayaklarınızı bir kağıt parçasının üzerine koyun ve kağıdın tüm ayaklarınızı kapladığından emin olun.
        </Description>
        <Step>2</Step>
        <Description>
            Topuğunuzun arkasına ve en uzun parmağınızın ucuna bir işaret koyun. Her iki işarete de yatay bir çizgi çizin.
        </Description>
        <Step>3</Step>
        <Description>
             İki yatay çizgi arasındaki mesafeyi ölçün.
        </Description>
        <ImageContainer>
          <Image src="https://www.schulershoes.com/media/wysiwyg/FootMeasureIcon.jpg" />
        </ImageContainer>
        <Button onClick={closeModal}>Çıkış</Button>
      </Wrapper>
    </Container>
  );
};
