    ...
    <Container>
      ...
      <Wrapper>
        ...
        <InfoContainer>
          ...
          <ChoiceContainer>
            <ChoiceWrapper>
              <ChoiceTitle>Kullanılabilir Renkler</ChoiceTitle>
              {product.color?.map((c) => (
                <ColorOutline
                  key={c}
                  id={c}
          ...
          <ChoiceTitle>Boyut Seçin</ChoiceTitle>
          <ChoiceContainer>
            <ChoiceWrapper>
              {product.size?.map((s) => {
                return (
          ...
          <TextContainer>
            <Left>
              <Action onClick={openSize}>
                ...
                <Description>Boyut ve Uyum kılavuzu</Description>
              </Action>
            </Left>
            <Right>
              <Action onClick={openNotify}>
                <NotificationAddOutlinedIcon />
                <Description>Stoklar tükendi?</Description>
              </Action>
            </Right>
          </TextContainer>
          <ChoiceContainer>
            <ChoiceWrapper>
              <ChoiceTitle>Miktar</ChoiceTitle>
              <QuantityWrapper>
                <QuantityButton
          ...
          <ButtonContainer>
            <Button onClick={addToBag}>
              <ShoppingBagOutlinedIcon style={{ marginRight: "10px" }} /> Sepete ekle
            </Button>
          </ButtonContainer>
          <Left>
            <DescriptionContainer>
              <AccessTimeOutlinedIcon />
              <Description>Şehir içi: 3-5 days, Şehir dışı: 10-15 days.</Description>
            </DescriptionContainer>
          </Left>
          <Left>
            <DescriptionContainer>
              <LocalShippingOutlinedIcon />
              <Description>₺2000.00 üzeri siparişlerde kargo ücretsiz</Description>
            </DescriptionContainer>
          </Left>
        </InfoContainer>
      </Wrapper>
      <PopularProducts description="İNSANLAR BUNLARA DA BAKTI" />
      <Newsletter />
      <Footer />
    </Container>
  );
