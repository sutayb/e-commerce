...
//stripe için Publishable key
const KEY =
  "pk_test_51L8WSkI7L3jBIScF72dnOILYvhYbWAOy85Scrc31vgxyLdX1q5yBkIcxH6HYJL2Co8o3MNZyzjcwTJF6VYGVQpcj00zSrL0e6S";
        ...
        <TextContainer>
          <Left>
            ...
            >
              ...
              <Text style={{ marginLeft: "5px" }}>geri</Text>
            </Action>
          </Left>
        </TextContainer>
        <BagContainer>
          <ProductContainer>
            <Subtitle>Çantadaki Ayakkabılar</Subtitle>
            <TextContainer>
              <Left>
                <Text>Ürünler</Text>
              </Left>
                    ...
                    <Left>
                      <Details>
                        ...
                        <ProductDetails>
                          ...
                          <ProductInfo> {product.size}cm</ProductInfo>
                          <ProductColor>
                            <ColorOutline>
          ...
          <SummaryContainer>
            <Summary>
              ...
              <SummaryItem>
                <SummaryItemText>Tahmini Kargo</SummaryItemText>
                <SummaryItemPrice>
                  {bag.quantity === 0
                    ? "--"
                    : bag.total > 4999
              ...
              <SummaryItem>
                <SummaryItemText>Nakliye İndirimi</SummaryItemText>
                <SummaryItemPrice>
                  {bag.quantity === 0
                    ? "--"
                    : bag.total > 4999
            ...
            <CheckOut>
              <StripeCheckout
                name="Sutay Shop"
                image="https://i.hizliresim.com/srrthef.png"
                billingAddress
                shippingAddress
            ...
            <TextContainer style={{ paddingTop: "20px" }}>
              ...
              >
                Visa kart deneme numarası{" "}
                <Copy onClick={() => handleCopy()}>4242 4242 4242 4242</Copy>
                -.- 12/34. cvc 567 .
              </Text>
            </TextContainer>
          </SummaryContainer>
