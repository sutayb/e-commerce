      ...
      <MainContainer>
        ...
        <TextContainer>
          ...
          {currentUser.isAdmin && (
            <Right>
              <Action>
                <Link href="admin panelinin linkini gircen">
        ...
        <Wrapper>
          <Header>Kullanıcı Bilgisi</Header>
          <InfoContainer>
            <Category>
              <InfoText>Adın:</InfoText>
            </Category>
            <Value>
          ...
          <InfoContainer>
            <Category>
              <InfoText>Kullanıcı Adın:</InfoText>
            </Category>
            <Value>
