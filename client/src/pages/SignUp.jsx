...
const SignUp = () => {
  ...
  return (
    <Container>
      ...
      <MainContainer>
        <Wrapper>
          <Title>Sutay-Fashion'a Katılın</Title>
          <Form onSubmit={handleSubmit}>
            ...
            password !== confirmPassword ? (
              <Error>Parola eşleşmedi</Error>
            ) : password !== "" && password.length < 8 ? (
              <Error>Şifre en az 8 karakter olmalıdır</Error>
            ) : username !== "" && username.length < 5 ? (
              <Error>Kullanıcı adı en az 5 karakter olmalıdır</Error>
            ) : null}
            <Agreement htmlFor="false" style={{ marginTop: "10px" }}>
              <CheckBox
                ...
                required
              />
              Okudum ve onaylıyorum <Link>Gizlilik Politikası</Link> ve{" "}
              <Link>Şartlar</Link>.
            </Agreement>
          ...
          >
            Zaten bir üye misiniz? Buraya Tıklayınız...
          </Options>
        </Wrapper>
      </MainContainer>
      <Footer />
