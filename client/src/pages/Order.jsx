...
const Order = () => {
  ...
  return (
    <Container>
      ...
      <Navbar />
      <Wrapper>
        <Title>Sipariş #{item._id.substring(0, 8)}</Title>
        <TextContainer>
          <Left>
            <Action
              onClick={() => {
        ...
        <OrderContainer>
          <ProductContainer>
            <Subtitle>Sipariş edilen Ayakkabılar</Subtitle>
            <TextContainer>
              <Left>
                <Text>Ürünler</Text>
              </Left>
          ...
          <SummaryContainer>
            <Summary>
              <SummaryLeft>
                <SummaryDiv>
                  <Subtitle>Fatura Özeti</Subtitle>
                  <SummaryItem>
                ...
                <SummaryDiv left={"left"}>
                  ...
                  <SummaryItem>
                    <SummaryItemLeft>Ara Toplam</SummaryItemLeft>
                    <SummaryItemRight>
                      {totalAmount < 5249
                  ...
                  <SummaryItem>
                    <SummaryItemLeft>Nakliye</SummaryItemLeft>
                    <SummaryItemRight>
                  ...
                  <Hr height={"2px"} />
                  <SummaryItem>
                    <SummaryItemLeft>Toplam</SummaryItemLeft>
                    <SummaryItemRight>
                      {formatAmount(totalAmount)}
                    </SummaryItemRight>
                  </SummaryItem>
